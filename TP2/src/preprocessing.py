...
def handle_missing_values(data):
    ...
    # Color faltante
    condicion_color_hilux = (data['Color'] =='nan') & (data['Tipo'] == 'Hilux SW4')
    condicion_color_corolla = (data['Color']=='nan') & (data['Tipo'] == 'Corolla Cross')    
    condicion_color_rav4 = (data['Color']=='nan') & (data['Tipo'] == 'RAV4')
    condicion_bordo = (data['Color'] =='Bordó')
    condicion_grafito = (data['Color'] =='Grafito')
    data.loc[condicion_color_hilux, 'Color'] = 'Gris' 
    data.loc[condicion_color_corolla, 'Color'] = 'Blanco'
    data.loc[condicion_color_rav4, 'Color'] = 'Blanco'
    data.loc[condicion_bordo, 'Color'] = 'Rojo'
    data.loc[condicion_grafito, 'Color'] = 'Gris Oscuro'
